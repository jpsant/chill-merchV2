    ...
    <div className="summer">
      ...
      <div className="summer-imageContainer">
        <img className={currentPage === 1 && currentSection === 3 ?
          ...
          'summer-imageContainer__image1 summer-image-1-out'} src={SummerImage1} alt="summer 1" />
          <img className={currentPage === 1 && currentSection === 3 ?
          'summer-imageContainer__image1-mobile summer-image-1-in' :
          'summer-imageContainer__image1-mobile summer-image-1-out'} src={SummerImage1Mobile} alt="summer 1" />
        ...
        <img className={currentPage === 1 && currentSection === 3 ?
          ...
          'summer-imageContainer__image2 summer-image-2-out'} src={SummerImage2} alt="summer 2" />
          <img className={currentPage === 1 && currentSection === 3 ?
          'summer-imageContainer__image2-mobile summer-image-2-in' :
          'summer-imageContainer__image2-mobile summer-image-2-out'} src={SummerImage2Mobile} alt="summer 2" />
        <div className={currentPage === 1 && currentSection === 3 ?
