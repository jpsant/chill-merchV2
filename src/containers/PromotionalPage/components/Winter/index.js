    ...
    <div className="winter">
      <div className="winter-titleContainer">
        ...
        <img className={currentPage === 1 && currentSection === 0 ?
          ...
          'winter-titleContainer-snow-flake logo-out'} src={Snow} alt="Snow Flake" />
      </div>
      <div className="winter-imageContainer">
        <img className={currentPage === 1 && currentSection === 0 ?
          'winter-imageContainer__image1 winter-image-1-in' :
          'winter-imageContainer__image1 winter-image-1-out'} src={WinterImage1} alt="Winter 1" />
        ...
        <img className={currentPage === 1 && currentSection === 0 ?
          ...
          'winter-imageContainer__image2 winter-image-2-out'} src={WinterImage2} alt="Winter 2" />
        <div className={currentPage === 1 && currentSection === 0 ?
