    ...
    <div className="spring">
      <div className="spring-titleContainer">
        <div className="spring-titleContainer-text">
          <h1
            className={
              currentPage === 1 && currentSection === 1
        ...
        <img
          className={
            currentPage === 1 && currentSection === 1
              ...
              : "spring-titleContainer-spring-leaf logo-out"
          }
          src={SpringFlower}
          alt="Spring Flower"
        />
        ...
        <img
          className={
            currentPage === 1 && currentSection === 1
              ...
              : "spring-imageContainer__image1 spring-image-1-out"
          }
          src={SpringImage1}
          alt="Spring Merch 1"
        />
        <img
          className={
            currentPage === 1 && currentSection === 1
              ...
              : "spring-imageContainer__image1-mobile spring-image-1-out"
          }
          src={SpringImage1mobile}
          alt="Spring Merch Mobile 1"
        />
        <div
          className={
            currentPage === 1 && currentSection === 1
        ...
        <img
          className={
            currentPage === 1 && currentSection === 1
              ...
              : "spring-imageContainer__image2 spring-image-2-out"
          }
          src={SpringImage2}
          alt="Spring Merch 2"
        />
        <img
          className={
            currentPage === 1 && currentSection === 1
              ...
              : "spring-imageContainer__image2-mobile spring-image-2-out"
          }
          src={SpringImage2mobile}
          alt="Spring Merch Mobile 2"
        />
        <div
          className={
            currentPage === 1 && currentSection === 1
